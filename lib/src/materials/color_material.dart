...
class ColorMaterial extends Material {
  static Program _program = _makeProgramForColorMaterial();
  static Pass _pass = _makePassForColorMaterial(_program);
...
Pass _makePassForColorMaterial(Program program) {
  var pass = new Pass();
